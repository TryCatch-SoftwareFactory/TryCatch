// <copyright file="ComponentNotFoundExceptionTests.cs" company="TryCatch Software Factory">
...
namespace TryCatch.UnitTests.Patterns.Factories
{
    ...
    public class ComponentNotFoundExceptionTests
    {
        ...
        public void Construct_without_args()
        {
            ...
            // Act
            var actual = new ComponentNotFoundException();
        ...
        public void Construct_with_message()
        {
            ...
            // Act
            var actual = new ComponentNotFoundException(message);
        ...
        public void Construct_with_innerException()
        {
            ...
            // Act
            var actual = new ComponentNotFoundException(message, innerException);
