// <copyright file="IExtendedRepository{TEntity}.cs" company="TryCatch Software Factory">
...
namespace TryCatch.Patterns.Repositories.Linq
{
    ...
    /// <summary>
    /// Extended repository pattern interface based on linq as a mechanism for query filtering.
    /// </summary>
