// <copyright file="EntityNotFoundExceptionTests.cs" company="TryCatch Software Factory">
// Copyright © TryCatch Software Factory All rights reserved.
// Licensed under the MIT license. See LICENSE.md file in the project root for full license information.
// </copyright>

namespace TryCatch.UnitTests.Exceptions
{
    using System;
    ...
    public class EntityNotFoundExceptionTests
    {
        ...
        public void Construct_without_args()
        {
            ...
            // Act
            var actual = new EntityNotFoundException();
        ...
        public void Construct_with_message()
        {
            ...
            // Act
            var actual = new EntityNotFoundException(message);
        ...
        public void Construct_with_innerException()
        {
            ...
            // Act
            var actual = new EntityNotFoundException(message, innerException);
